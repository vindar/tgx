/********************************************************************
 *
 * TGX example for Waveshare ESP32-P4-WIFI6-Touch-LCD-XC.
 *
 * Large tile-rendered cone example. TGX renders a 720x720
 * virtual viewport in nine 720x80 internal-RAM tiles. While TGX draws
...
namespace
{
    ...
    static constexpr int VIEW_W = 720;
    static constexpr int VIEW_H = 720;
