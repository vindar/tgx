...
void loop()
    {
    renderer.setModelLightning(RGBf(0.15f, 0.7f, 0.39f), 0.2f, 0.8f, 0.5f, 8); // teapot
    drawMesh(&teapot, 15, 30);

    renderer.setModelLightning(RGBf(1.0f, 1.0f, 1.0f), 0.15f, 0.7f, 0.8f, 48); // bunny
    drawMesh(&bunny, 12);

    renderer.setModelLightning(RGBf(166 / 256.0f, 130 / 256.0f, 110.0f / 256.0f), 0.15f, 0.7f, 0.4f, 16); // skull
    drawMesh(&skull_1, 12);
    ...
    renderer.setModelLightning(RGBf(1.0f, 1.0f, 1.0f), 0.2f, 0.8f, 0.8f, 32); // suzanne
    drawMesh(&suzanne, 13);
    ...
    renderer.setModelLightning(RGBf(0.85f, 0.55f, 0.25f), 0.2f, 0.7f, 0.8f, 64); // dragon
    drawMesh(&dragon, 15);
