...
// The sketch centers this viewport in the physical screen.  On a small ST7735
// the actual size will simply be clamped to the display size.
static const int MAX_LX = 220;
static const int MAX_LY = 165;
