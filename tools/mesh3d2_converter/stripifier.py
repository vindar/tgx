...
EXTERNAL_BIN = TOOL_ROOT / "external_libs" / "bin"
LEGACY_LKH_EXE = Path(r"D:\Programmation\myProjects\tgxmeshlets\LKH-2.exe")
...
if not DEFAULT_LKH_EXE.exists() and LEGACY_LKH_EXE.exists():
    DEFAULT_LKH_EXE = LEGACY_LKH_EXE
