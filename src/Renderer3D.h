    ...
    */
    ...
    class Renderer3D
    {
        ...
        ******************************************************************************************/
        ...
        /**
         * Draw a Mesh3D2 object.
         *
         * @param   mesh                The mesh to draw.
         * @param   use_mesh_material   True (default) to use Mesh3D2 material colors and lighting
         *                              coefficients, otherwise use the current renderer material.
         *
         * @remark
         * - Mesh3D2 is the meshlet-based mesh format. Unlike Mesh3D, multi-material models are stored
         *   as a single mesh with a material table and one material index per meshlet.
