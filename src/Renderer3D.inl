...
namespace tgx
{
    ...
    *********************************************************/
        ...
        template<typename color_t, int LOADED_SHADERS, typename ZBUFFER_t> TGX_NOINLINE
     ...
     ********************************************************/
        ...
        template<typename color_t, int LOADED_SHADERS, typename ZBUFFER_t> TGX_NOINLINE
        void Renderer3D<color_t, LOADED_SHADERS, ZBUFFER_t>::setShaders(int shaders)
            {
        ...
        template<typename color_t, int LOADED_SHADERS, typename ZBUFFER_t> TGX_NOINLINE
        void Renderer3D<color_t, LOADED_SHADERS, ZBUFFER_t>::setTextureWrappingMode(int wrap_mode)
            {
        ...
        template<typename color_t, int LOADED_SHADERS, typename ZBUFFER_t> TGX_NOINLINE
        void Renderer3D<color_t, LOADED_SHADERS, ZBUFFER_t>::setTextureQuality(int quality)
            {
    ...
    *********************************************************/
        ...
        template<typename color_t, int LOADED_SHADERS, typename ZBUFFER_t>
    ...
    ******************************************************************************************/
        ...
        template<typename color_t, int LOADED_SHADERS, typename ZBUFFER_t>
        void Renderer3D<color_t, LOADED_SHADERS, ZBUFFER_t>::_rectifyShaderShading(int new_shaders)
            {
