 ...
 * Set to 1 to let Mesh3D2_16b skip per-triangle clipping for meshlets whose bounding sphere is fully inside the frustum, and discard meshlets fully outside.
 */
