...
namespace tgx
{
    ...
    namespace Mesh3Dv2_detail
    {
        ...
        TGX_INLINE inline fVec4 load_vertex_transformed(const int16_t* table, uint8_t index,
                                                        const fVec4& base,
                                                        const fVec4& sx,
                                                        const fVec4& sy,
                                                        const fVec4& sz)
        ...
        TGX_INLINE inline fVec4 load_normal_transformed(const int16_t* table, uint8_t index,
                                                        const fVec4& sx,
                                                        const fVec4& sy,
                                                        const fVec4& sz)
            {
